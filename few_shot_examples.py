...
3. ✓ **박스 안에 여러 줄이 있나요? → 모든 줄을 읽고 \\n으로 구분!** ⚠️
4. ✓ 손글씨를 정확히 읽었나요?
5. ✓ 대소문자를 구분했나요?
6. ✓ 문장부호를 정확히 인식했나요?
7. ✓ 숫자와 알파벳을 구분했나요?
8. ✓ 원본 텍스트 위치(필드명)를 확인했나요?
9. ✓ 모든 붉은색 마킹을 빠짐없이 찾았나요?
...
3. ⚠️ **박스 안에 여러 줄이 있는지 확인** - 있으면 모든 줄을 읽기!
4. 박스로 표시된 원본 텍스트를 정확히 읽기 (여러 줄이면 \\n으로 구분)
5. 화살표가 가리키는 손글씨를 정확히 읽기 (여러 줄이면 \\n으로 구분)
6. 해당 텍스트가 위치한 문서 필드명 파악
7. 신뢰도 평가 (high/medium/low)
