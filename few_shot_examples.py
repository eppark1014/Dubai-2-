...
이미지 설명: Port of Loading 필드에 "#20"과 "#15" 번호가 표시되고, 그 주변에 손글씨가 있음
  - #20 주변에 "JEBEL ALI" 같은 손글씨
  - #15 주변에 "DUBAI" 같은 손글씨
  - Port of Loading 필드의 원본 텍스트와 비교
분석 결과:
{
  "order": 6,
  "action": "수정",
  "original_text": "Port of Loading 필드의 원본 텍스트",
  "new_text": "#20: JEBEL ALI / #15: DUBAI",
  "location": "Port of Loading",
  "confidence": "high"
}
⚠️ 주의: 번호 표시(#20, #15)는 명확한 화살표 없이도 수정 지시사항입니다!
"""
...
7. 박스로 표시된 원본 텍스트를 정확히 읽기 (여러 줄이면 \\n으로 구분)
...
- 🔴 **Port of Loading의 원본 텍스트와 새 텍스트를 모두 찾으세요!**
