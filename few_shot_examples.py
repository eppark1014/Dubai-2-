...
⚠️ 중요: 텍스트 위에 물결선(~~~)이나 취소선(---)이 그어져 있으면 100% 삭제입니다!
...
2. ✓ 화살표가 있나요? → 수정
3. ✓ **물결선(~~~, 돼지꼬리) 또는 취소선(---)이 있나요? → 100% 삭제!** ⚠️⚠️
...
4. ⚠️⚠️ **각 마킹 위에 물결선(~~~) 또는 취소선(---)이 있는지 확인**:
   - 물결선이나 취소선이 있으면 = 100% 삭제
...
### 마킹 인식 규칙:
- 화살표(→)가 보이면 반드시 "수정"
- **물결선(~~~, 돼지꼬리) 또는 취소선(---)이 있으면 100% "삭제"** ⚠️⚠️
